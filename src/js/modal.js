...
export function openModal() {
  ...
  refs.modalWindow.classList.add('modal--is-open'); //  прибрати клас та сховати модальне вікно - бекдропа
  refs.modalContent.classList.add('modal--is-open'); // прибрати клас та сховати  контент модального вікна
